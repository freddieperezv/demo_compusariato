...
class BtAssetMove(models.Model):
    ...
    from_loc_id = fields.Many2one('bt.asset.location', string='Source location', required=True)
    asset_id = fields.Many2one('bt.asset', string='Asset', required=False, copy=False)
    to_loc_id = fields.Many2one('bt.asset.location', string='Destination location', required=True)
