    ...
    def action_post(self):
        ...
        for inv in self:
            if inv.show_partner_credit_warning and inv.credit_limit_type == 'block' and \
                    ...
                    # inv.partner_credit + inv.amount_total > inv.partner_credit_limit:   fpe:Se comentó porque partner_credit ya tiene considerado el valor de la factura, se los estaba volviendo a cargar a la formula
